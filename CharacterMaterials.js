...
let charactersMaterials = [
    ...
    new CharacterMaterials("Charlotte",         "cryo",     "DPS",      "Tourbillon Device",        "Beryl Conch",          "Clockwork Meka",       "Justice",      "Lightless Silk String"),
    ...
    new CharacterMaterials("Lynette",           "anemo",    "DPS",      "Coppelia",                 "Lumidouce Bell",       "Clockwork Meka",       "Order",        "Everamber"),
    new CharacterMaterials("Kirara",            "dendro",   "DPS",      "Evergloom Ring",           "Amakumo Fruit",        "Specter",              "Transience",   "Everamber"),
    new CharacterMaterials("Baizhu",            "dendro",   "DPS",      "Evergloom Ring",           "Violetgrass",          "Fungus",               "Gold",         "Worldspan Fern"),
    new CharacterMaterials("Kaveh",             "dendro",   "DPS",      "Quelled Creeper",          "Mourning Flower",      "Fungus",               "Ingenuity",    "Primordial Greenbloom"),
    new CharacterMaterials("Mika",              "cryo",     "Support",  "Pseudo-Stamens",           "Wolfhook",             "Fatui",                "Ballad",       "Mirror of Mushin"),
    new CharacterMaterials("Dehya",             "pyro",     "Support",  "Light Guiding Tetrahedron", "Sand Grease Pupa",    "Eremites",             "Praxis",       "Puppet Strings"),
    new CharacterMaterials("Alhaitham",         "dendro",   "Support",  "Pseudo-Stamens",           "Sand Grease Pupa",     "Eremites",             "Ingenuity",    "Mirror of Mushin"),
    new CharacterMaterials("Yaoyao",            "dendro",   "Support",  "Quelled Creeper",          "Jueyun Chili",         "Slimes",               "Diligence",    "Daka's Bell"),
    new CharacterMaterials("Wanderer",          "anemo",    "Support",  "Perpetual Caliber",        "Rukkhashava Mushrooms", "Nobushi",             "Praxis",       "Daka's Bell"),
    ...
    new CharacterMaterials("Cyno",              "electro",  "Support",  "Thunderclap Fruitcore",    "Scarab",               "Samachurls",           "Admonition",   "Mudra of the Malefic General"),
    ...
    new CharacterMaterials("Tighnari",          "dendro",   "Support",  "Majestic Hooked Beak",     "Nilotpala Lotus",      "Fungus",               "Admonition",   "The Meaning of Aeons"),
    ...
    new CharacterMaterials("Shikanoin Heizou",  "anemo",    "Support",  "Runic Fang",               "Onikabuto",            "Treasure Hoarders",    "Transience",   "The Meaning of Aeons"),
    ...
    new CharacterMaterials("Kamisato Ayato",    "hydro",    "Support",  "Dew of Repudiation",       "Sakura Bloom",         "Nobushi",              "Elegance",     "Mudra of the Malefic General"),
    new CharacterMaterials("Yae Miko",          "electro",  "Support",  "Dragonheir's False Fin",   "Sea Ganoderma",        "Nobushi",              "Light",        "The Meaning of Aeons"),
    ...
    new CharacterMaterials("Arataki Itto",      "geo",      "Support",  "Riftborn Regalia",         "Onikabuto",            "Slimes",               "Elegance",     "Ashen Heart"),
    ...
    new CharacterMaterials("Sangonomiya Kokomi", "hydro",   "Support",  "Dew of Repudiation",       "Sango Pearl",          "Specter",              "Transience",   "Hellfire Butterfly"),
    ...
    new CharacterMaterials("Yoimiya",           "pyro",     "Support",  "Smoldering Pearl",         "Naku Weed",            "Samachurls",           "Transience",   "Dragon Lord's Crown"),
    new CharacterMaterials("Sayu",              "anemo",    "Support",  "Marionette Core",          "Crystal Marrow",       "Whopperflowers",       "Light",        "Gilded Scale"),
    new CharacterMaterials("Kamisato Ayaka",    "cryo",     "Support",  "Perpetual Heart",          "Sakura Bloom",         "Nobushi",              "Elegance",     "Bloodjade Branch"),
    ...
    new CharacterMaterials("Eula",              "cryo",     "Support",  "Crystalline Bloom",        "Dandelion Seed",       "Hilichurls",           "Resistance",   "Dragon Lord's Crown"),
    new CharacterMaterials("Yanfei",            "pyro",     "Support",  "Juvenile Jade",            "Noctilucous Jade",     "Treasure Hoarders",    "Gold",         "Bloodjade Branch"),
    new CharacterMaterials("Rosaria",           "cryo",     "Support",  "Hoarfrost Core",           "Valberry",             "Fatui",                "Ballad",       "Shadow of the Warrior"),
    new CharacterMaterials("Hu Tao",            "pyro",     "Support",  "Juvenile Jade",            "Silk Flower",          "Whopperflowers",       "Diligence",    "Shard of a Foul Legacy"),
    new CharacterMaterials("Xiao",              "anemo",    "Support",  "Juvenile Jade",            "Qingxin",              "Slimes",               "Prosperity",   "Shadow of the Warrior"),
    new CharacterMaterials("Ganyu",             "cryo",     "Support",  "Hoarfrost Core",           "Qingxin",              "Whopperflowers",       "Diligence",    "Shadow of the Warrior"),
    ...
    new CharacterMaterials("Tartaglia",         "hydro",    "Support",  "Cleansing Heart",          "Starconch",            "Fatui",                "Freedom",      "Shard of a Foul Legacy"),
    ...
    new CharacterMaterials("Keqing",            "electro",  "Support",  "Lightning Prism",          "Cor Lapis",            "Whopperflowers",       "Prosperity",   "Ring of Boreas"),
    ...
    new CharacterMaterials("Diluc",             "pyro",     "Support",  "Everflame Seed",           "Small Lamp Grass",     "Fatui",                "Resistance",   "Dvalin's Plume"),
    ...
    new CharacterMaterials("Noelle",            "geo",      "Support",  "Basalt Pillar",            "Valberry",             "Hilichurls",           "Resistance",   "Dvalin's Claw"),
    ...
    new CharacterMaterials("Beidou",            "electro",  "Support",  "Lightning Prism",          "Noctilucous Jade",     "Treasure Hoarders",    "Gold",         "Dvalin's Sigh"),
    new CharacterMaterials("Xiangling",         "pyro",     "Support",  "Everflame Seed",           "Jueyun Chili",         "Slimes",               "Diligence",    "Dvalin's Claw"),
    new CharacterMaterials("Razor",             "electro",  "Support",  "Lightning Prism",          "Wolfhook",             "Hilichurls",           "Resistance",   "Dvalin's Claw"),
    ...
    new CharacterMaterials("Amber",             "pyro",     "Support",  "Everflame Seed",           "Small lamp grass",     "Hilichurl Shooters",   "Freedom",      "Dvalin's Sigh"),
]
