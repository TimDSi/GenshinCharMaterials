...
*/
let myCharacter = [
    new Character("Gaming",             80, [1, 8, 6],  4),
    new Character("Xianyun",            70, [1, 6, 5],  0),
    ...
    new Character("Yelan",              80, [6, 9, 9],  1),
    ...
    new Character("Thoma",              80, [6, 8, 6],  6),
    new Character("Sangonomiya Kokomi", 80, [8, 9, 9],  0),
    ...
    new Character("Rosaria",            80, [6, 6, 6],  6),
    ...
    new Character("Diona",              80, [6, 6, 6],  6),
    ...
    new Character("Diluc",              80, [9, 9, 9],  2),
    new Character("Jean",               80, [6, 9, 9],  3),
    new Character("Sucrose",            80, [6, 9, 9],  6),
    new Character("Chongyun",           80, [6, 9, 9],  2),
    ...
    new Character("Razor",              80, [6, 6, 6],  3),
    new Character("Barbara",            80, [6, 7, 6],  6),
    new Character("Lisa",               80, [6, 6, 6],  6),
    new Character("Kaeya",              80, [6, 6, 7],  4),
    new Character("Amber",              80, [6, 7, 6],  6)
];
