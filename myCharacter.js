...
let myCharacter = [
    ...
    new Character("Freminet",           80, [9, 9, 9],  1), 
    ...
    new Character("Candace",            80, [6, 9, 7],  4), 
    new Character("Dori",               80, [6, 6, 9],  5), 
    ...
    new Character("Rosaria",            80, [6, 6, 8],  6), 
    ...
    new Character("Beidou",             80, [6, 7, 9],  6), 
    new Character("Xiangling",          80, [6, 9, 9],  6), 
    new Character("Razor",              80, [9, 9, 7],  4), 
